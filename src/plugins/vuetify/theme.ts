...
const envPrimaryColor = import.meta.env.VITE_APPS_PRIMARY_COLOR
const envPrimaryDarkenColor = import.meta.env.VITE_APPS_PRIMARY_DARKEN_COLOR

export const staticPrimaryColor = envPrimaryColor || '#3478E4'
export const staticPrimaryDarkenColor = envPrimaryDarkenColor || '#1E66D8'
