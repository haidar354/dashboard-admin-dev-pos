...
const onUpdateModifier = (index: number) => {
  if (createForm.value?.modifiers?.[index])
    createForm.value.modifiers[index].modifierGroupId = selectedModifiers.value[index].modifierGroupId
}
</script>
      ...
      <VRow>
        <VCol cols="12">
          <VRow>
            <VCol cols="12">
              ...
              >
                ...
                <VSwitch
                  ...
                  v-model="createForm.hasModifier"
                  name="hasModifierMaster"
                  :rules="[requiredValidator]"
                  :error-messages="createFormErrors?.hasModifier"
                  :label="createForm.hasModifier ? 'Ya' : 'Tidak'"
                  :true-value="true"
                  :false-value="false"
                  color="warning"
                  inset
            ...
            <VCol
              v-if="createForm.hasModifier"
              cols="12"
            >
              <div v-if="(createForm.modifiers?.length || 0) > 0">
                <VRow
                  v-for="(modifier, index) in (createForm.modifiers || [])"
                  :key="index"
                  class="mb-4"
                >
                  <VCol cols="12">
                        ...
                        <VRow align="center">
                          ...
                          >
                            ...
                            <VAutocomplete
                              ...
                              v-model="selectedModifiers[index]"
                          ...
                          >
                            ...
                            <VSwitch
                              v-if="createForm.modifiers?.[index]?.isRequired !== undefined"
                              :id="`modifier-${index}-is-required`"
                              v-model="createForm.modifiers[index].isRequired"
                              :name="`modifiers[${index}][isRequired]`"
                              :label="createForm.modifiers[index].isRequired ? 'Ya' : 'Tidak'"
                              :true-value="true"
                              :false-value="false"
                              color="warning"
                              inset
                          ...
                          <VCol cols="12">
                            <VCard
                              v-for="(option, optionIndex) in selectedModifiers[index]?.options || []"
                              :key="optionIndex"
                              variant="outlined"
                            >
                              <VCardItem>
                                ...
                                <VRow>
                                  <VCol cols="6">
                                    ...
                                    <VTextField
                                      ...
                                      :value="selectedModifiers[index]?.options[optionIndex]?.name || ''"
                                      variant="outlined"
                                      readonly
                                    />
                                  </VCol>
