...
import { useMaterialCreate } from '@/composables/inventory/useMaterialCreate'
          ...
          <VCardText>
            <VRow>
              ...
              >
                ...
                <VAutocomplete
                  v-model="createForm.outletIds"
                  :items="outlets"
                  item-title="name"
                  item-value="outletId"
                  :rules="[requiredValidator]"
                  :error-messages="createFormErrors?.outletIds"
          ...
          <VCardText>
            <VRow>
              ...
              >
                ...
                <VSwitch
                  v-model="createForm.itemConfigs[0].isActive"
                  :label="createForm.itemConfigs[0].isActive ? 'Aktif' : 'Tidak aktif'"
                  :true-value="true"
                  :false-value="false"
                  color="success"
                  inset
              ...
              >
                ...
                <VSwitch
                  v-model="createForm.itemConfigs[0].manageStock"
                  :label="createForm.itemConfigs[0].manageStock ? 'Ya, monitor' : 'Tidak monitor'"
                  :true-value="true"
                  :false-value="false"
                  color="success"
                  inset
              ...
              >
                ...
                <VSwitch
                  v-model="createForm.itemConfigs[0].allowNegativeStock"
                  :label="createForm.itemConfigs[0].allowNegativeStock ? 'Ya, perbolehkan' : 'Tidak perbolehkan'"
                  :true-value="true"
                  :false-value="false"
                  color="success"
                  inset
                  :disabled="!createForm.itemConfigs[0].manageStock"
                />
              </VCol>
              ...
              >
                ...
                <AppTextField
                  v-model="createForm.itemConfigs[0].minStockAlert"
                  type="number"
              ...
              >
                ...
                <AppTextField
                  v-model="createForm.itemConfigs[0].cashierMaxPriceChangePct"
                  type="number"
          ...
          <VCardItem>
            ...
            <template #append>
              <VBtn
                ...
                variant="outlined"
                size="small"
                @click="addNewBlankUnit(createForm.itemUnits.length ? (createForm.itemUnits[createForm.itemUnits.length - 1]?.conversion + 1) : 2)"
              >
                Tambah
              </VBtn>
            </template>
            ...
            <VTable>
              <thead>
                <tr>
                  ...
                  <td width="20%">
                    Harga Beli <span
                      v-if="createForm.itemConfigs[0]?.manageStock"
                      class="text-error"
                    >*</span>
                  </td>
                  <td width="20%">
              ...
              <tbody>
                <tr
                  v-for="(unit, index) in createForm.itemUnits"
                  :key="index"
                >
                  <td>
                    <VAutocomplete
                  ...
                  <td>
                    <AppTextField
                      ...
                      :min="createForm.itemUnits.length ? (createForm.itemUnits[index - 1]?.conversion + 1) : 1"
                    >
                      <template #append-inner>
                        <span>{{ defaultUnit?.unit?.code }}</span>
                      </template>
