...
import type { OutgoingLetterStats } from '@/types/models/dashboard'

const props = defineProps<{
  data?: OutgoingLetterStats | null
  isLoading?: boolean
}>()
...
<template>
  <VCard
    ...
    subtitle="Menampilkan statistik surat keluar"
  >
    <VDivider />
      ...
      <div class="border rounded mt-5 pa-5">
        <VRow>
          ...
          >
            ...
            <VProgressLinear
              :model-value="data?.pending_count || 0"
              :min="0"
              :max="data?.total || 0"
              color="primary"
              height="4"
          ...
          >
            ...
            <VProgressLinear
              :model-value="data?.approved_count || 0"
              :min="0"
              :max="data?.total || 0"
              color="success"
              height="4"
          ...
          >
            ...
            <VProgressLinear
              :model-value="data?.rejected_count || 0"
              :min="0"
              :max="data?.total || 0"
              color="error"
              height="4"
