...
definePage({
  meta: {
    ...
    navActiveLink: 'purchase-directs',
  },
})
    ...
    <template v-else-if="purchaseDirect.purchaseDirectId">
      ...
      >
              ...
              <div class="d-flex gap-2 align-center">
                ...
                <div>
                  ...
                  <div class="text-body-2 text-medium-emphasis">
                    {{ purchaseDirect.documentCode }} - {{ dayjs(purchaseDirect.purchasedAt).format('DD MMMM YYYY') }}
                  </div>
                </div>
              </div>
            </div>
        ...
        <VCardText class="pb-2">
          <div class="d-flex flex-wrap gap-2">
            ...
            <VBtn
              v-if="purchaseDirect.documentAttachment"
              color="info"
              variant="outlined"
            ...
            <VBtn
              v-if="($can('manage', 'Hapus Pembelian Langsung') || $can('manage', 'default')) && purchaseDirect.status !== 'COMPLETED'"
              color="error"
              variant="outlined"
      ...
      <VRow>
                  ...
                  <div class="mb-4">
                    ...
                    <div class="d-flex align-center">
                      ...
                      <span class="text-h6 font-weight-bold text-success">
                        {{ formatRupiah(purchaseDirect.grandTotal) }}
                      </span>
                    </div>
                  </div>
        ...
        >
            ...
            <VCardText>
              <div class="d-flex justify-space-between align-center mb-3">
                ...
                <VChip
                  ...
                  variant="flat"
                >
                  {{ purchaseDirect.items?.length || 0 }} item
                </VChip>
              </div>
              ...
              <div class="d-flex justify-space-between align-center mb-3">
                ...
                <span class="font-weight-medium">
                  {{ Math.round(purchaseDirect.items?.reduce((sum, item) => sum + item.qty, 0) || 0) }}
                </span>
              </div>
          ...
          <!-- Document Card -->
          <VCard
            v-if="purchaseDirect.documentAttachment || purchaseDirect.invoiceNumber"
            class="mb-4"
            elevation="2"
          >
            <VCardTitle class="d-flex align-center">
            ...
            <VCardText>
              <div
                v-if="purchaseDirect.invoiceNumber"
                class="mb-4"
              >
                <label class="text-body-2 text-medium-emphasis mb-1 d-block">Nomor Faktur</label>
                <div class="d-flex align-center">
                  <VAvatar
                    size="24"
                    color="primary"
      ...
      <VCard elevation="2">
        ...
        >
          ...
          <template #item.sku.item.category.name="{ item }">
            <VChip
              size="small"
              variant="outlined"
              color="info"
              ...
              <div class="d-flex justify-end">
                <div class="text-right">
                  <div class="text-h6 font-weight-bold text-success">
                    Total: {{ formatRupiah(purchaseDirect.grandTotal) }}
                  </div>
                  <div class="text-body-2 text-medium-emphasis">
                    {{ purchaseDirect.items?.length || 0 }} barang
                  </div>
                </div>
              </div>
            </div>
      ...
      <VCardText>
        <div class="text-center pa-8">
          ...
          <VBtn
            color="primary"
            variant="elevated"
            @click="router.push({ name: 'purchase-directs' })"
          >
