...
const { data: outlets, isLoadingFetchData: isLoadingFetchOutlet } = storeToRefs(outletStore)
    ...
    <slot name="before-nav-items">
      ...
      <div class="px-4 mb-4">
        <div class="d-flex flex-column gap-4">
          <VAutocomplete
            v-model="outletStore.selectedSidebarOutlet"
            class="mt-1"
            :items="outletList"
            item-title="name"
            item-value="outletId"
            :loading="isLoadingFetchOutlet"
            return-object
            label="Outlet"
          />
        </div>
